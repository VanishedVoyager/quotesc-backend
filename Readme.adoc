...
:diagram-processor: doc/diagram.adoc
ifdef::env-github[]
:diagram-processor: doc/diagram-gh.adoc
:repolink: VanishedWanderer/quotesc-backend/model-rework
endif::[]
...
== ERD
:diagdir: doc/erd.puml
include::{diagram-processor}[]
